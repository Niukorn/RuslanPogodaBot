...
GREETING = (
    ...
    "Напиши мне название города, и я расскажу тебе о погоде.\n\n"
    "📋 Все команды — /commands"
)

CITY_DB = {
    "москва": {"name": "Москва", "lat": 55.7558, "lon": 37.6173, "country": "Россия", "region": "Москва"},
    "спб": {"name": "Санкт-Петербург", "lat": 59.9343, "lon": 30.3351, "country": "Россия", "region": "Санкт-Петербург"},
    "санкт-петербург": {"name": "Санкт-Петербург", "lat": 59.9343, "lon": 30.3351, "country": "Россия", "region": "Санкт-Петербург"},
    ...
    "минск": {"name": "Минск", "lat": 53.9045, "lon": 27.5615, "country": "Беларусь", "region": "Минская область"},
    "киев": {"name": "Киев", "lat": 50.4501, "lon": 30.5234, "country": "Украина", "region": ""},
    "одесса": {"name": "Одесса", "lat": 46.4825, "lon": 30.7233, "country": "Украина", "region": ""},
    "алматы": {"name": "Алматы", "lat": 43.2220, "lon": 76.8512, "country": "Казахстан", "region": ""},
    "астана": {"name": "Астана", "lat": 51.1694, "lon": 71.4491, "country": "Казахстан", "region": ""},
    "ташкент": {"name": "Ташкент", "lat": 41.2995, "lon": 69.2401, "country": "Узбекистан", "region": ""},
    "баку": {"name": "Баку", "lat": 40.4093, "lon": 49.8671, "country": "Азербайджан", "region": ""},
    "ереван": {"name": "Ереван", "lat": 40.1792, "lon": 44.4991, "country": "Армения", "region": ""},
    "тбилиси": {"name": "Тбилиси", "lat": 41.7151, "lon": 44.8271, "country": "Грузия", "region": ""},
    "берлин": {"name": "Берлин", "lat": 52.5200, "lon": 13.4050, "country": "Германия", "region": ""},
    "лондон": {"name": "Лондон", "lat": 51.5074, "lon": -0.1278, "country": "Великобритания", "region": ""},
    "париж": {"name": "Париж", "lat": 48.8566, "lon": 2.3522, "country": "Франция", "region": ""},
    "нью-йорк": {"name": "Нью-Йорк", "lat": 40.7128, "lon": -74.0060, "country": "США", "region": ""},
    "токио": {"name": "Токио", "lat": 35.6762, "lon": 139.6503, "country": "Япония", "region": ""},
    "пекин": {"name": "Пекин", "lat": 39.9042, "lon": 116.4074, "country": "Китай", "region": ""},
    "дубай": {"name": "Дубай", "lat": 25.2048, "lon": 55.2708, "country": "ОАЭ", "region": ""},
    "стамбул": {"name": "Стамбул", "lat": 41.0082, "lon": 28.9784, "country": "Турция", "region": ""},
}
...
async def cmd_commands(message: Message):
    text = (
        "📋 Список команд:\n\n"
        "🏙 Название города — текущая погода, ветер, влажность + прогноз по часам на 12ч\n"
        "📅 /week — прогноз на 7 дней (после запроса города)\n"
        "📜 /history — история последних 10 запросов\n"
        "⚠️ /alerts — предупреждения: мороз, жара, ветер, гроза, ливень\n"
        "📧 /feedback — отправить отзыв о боте"
    )
...
async def cmd_history(message: Message):
    ...
    if user_id not in user_history or not user_history[user_id]:
        await message.answer("📭 История пуста. Напишите название города.")
        return
